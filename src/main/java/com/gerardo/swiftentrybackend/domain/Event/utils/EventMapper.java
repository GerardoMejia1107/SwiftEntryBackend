...
public class EventMapper {
    ...
    public EventResponseDTO toResponse(EventModel event, List<LocalityModel> localityModels) {
        return EventResponseDTO.builder()
                ...
                .streetAddress(event.getAddress() != null ? event.getAddress()
                        .getStreetAddress() : null)
                .neighborhood(event.getAddress() != null ? event.getAddress()
                        .getNeighborhood() : null)
                .municipality(event.getAddress() != null ? event.getAddress()
                        .getMunicipality() : null)
                .department(event.getAddress() != null ? event.getAddress()
                        .getDepartment() : null)
                .country(event.getAddress() != null ? event.getAddress()
                        .getCountry() : null)
                .referencePoint(event.getAddress() != null ? event.getAddress()
